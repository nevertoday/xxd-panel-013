<p align="center">
  <img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 013" width="1200">
</p>

<div align="center" dir="rtl">

# 🦁 XXD Panel 013｜ألبوم تذاكر السفر

### يحفظ الصورة داخل تذكرة مائية هادئة قابلة للاقتناء

[![Codex Skill](https://img.shields.io/badge/Codex-Skill-000000?style=flat-square)](./SKILL.md)
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#أربعة-مخرجات-ومنطق-واحد-لتذكرة-مائية-قابلة-للاقتناء)
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 013 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 013 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 013 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 013 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 013. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 013 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 013 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 013 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 013 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>
...
> تذكرة أفقية واحدة · تقسيم 74/26 · ألوان مائية مريحة · فراغ عاجي · قسيمة معلومات محلية اللغة

XXD Panel 013 مهارة لتوليد الصور مخصّصة لـ Codex والوكلاء المتوافقين. تحافظ على الهوية والمحيط والوضع والبيئة الضرورية التي تجعل اللحظة قابلة للتذكر، ثم تلخّص هذه العلاقة داخل تذكرة مائية أفقية واحدة معلّقة في المركز بدلاً من عزل شيء واحد ورسمه.
...
يناسب **Panel 013** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **يحفظ الصورة داخل تذكرة مائية هادئة قابلة للاقتناء**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 013 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 013 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | يحفظ الصورة داخل تذكرة مائية هادئة قابلة للاقتناء |
| **السمات التي تُعرف من النظرة الأولى** | تذكرة أفقية واحدة · تقسيم 74/26 · ألوان مائية مريحة · فراغ عاجي · قسيمة معلومات محلية اللغة |
...
تعكس 013 هذا الترتيب:

```text
تثبيت الموضوع والبيئة الضرورية ← حفظ ثلاث علامات خاصة بالمصدر على الأقل ← تلخيصهما في تذكرة أفقية واحدة في المركز ← تقسيمها نحو 74/26 بين المشهد والقسيمة ← ترجمة اللون إلى لونين أو أربعة ألوان مريحة متجاورة ← إبقاء الموضوع أوضح قليلاً وتخفيف البيئة ← محاذاة الحقول المحلية والختم وخط الثقب على شبكة واحدة
```

إذا أمكن استبدال المصدر بصورة لا صلة لها من دون تغيير جوهري في الموضوع المائي أو البيئة الضرورية أو الألوان أو معاني الحقول أو علاقة الختم أو النص، فالنتيجة ليست 013.

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- **الموضوع والبيئة الضرورية:** تحفظ ثلاث علامات خاصة بالمصدر على الأقل الهوية والوضع والمقياس والمكان والمعلم والعلاقة المكانية.
- **تذكرة أفقية واحدة:** تتوسط فراغاً عاجياً واسعاً ولا تتكرر ولا تتحول إلى ملصقة ولا تملأ اللوحة.
- **نحو 74/26:** يكون المشهد المائي الأيسر أكبر بوضوح، وتفصله عن قسيمة المعلومات المدمجة ثقوب أو خط قطع رأسي دقيق واحد.
- **ألوان مائية مريحة:** لونان إلى أربعة ألوان مصدرية متجاورة عالية الإضاءة ومنخفضة إلى متوسطة التشبع، مع بياض الورق والتفتح وتغير البلل والجفاف وقليل من حبيبات الصبغة.
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 013. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-013 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-013 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-013 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-013 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-013 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 013 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-013 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بـ `~/.claude/skills/xxd-panel-013`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
- [مهايئ التشغيل الصيني](references/xxd-panel-013-prompt.zh-CN.md)
- [مهايئ التشغيل الإنجليزي](references/xxd-panel-013-prompt.en.md)
...
**لا تضع قالب سفر فوق الصورة؛ احتفظ بعلاقتها نفسها في هيئة تذكرة تخصها وحدها.**
