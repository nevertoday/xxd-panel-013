...
يحتفظ المستودع بمجلد [`assets/examples/`](assets/examples/) للأعمال القادمة. لن يُضاف إلا عمل مكتمل بأسلوب 013 ومؤكد من صاحب المشروع؛ ولن تُستخدم منشورات أو صور من أساليب أخرى كعناصر مؤقتة.

ستعرض النماذج القادمة قدرة 013 على التكيف فقط، ولن تصبح موضوعاتها أو استعاراتها أو ألوانها أو نصوصها أو نسبها مراجع للتوليد أو قيماً افتراضية.

## أربعة مخرجات ومنطق واحد لتذكرة مائية قابلة للاقتناء
...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى، وتذكرة 013 المائية القابلة للاقتناء في الأسفل؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار، وتذكرة 013 المائية القابلة للاقتناء في اليمين؛ يحتفظ اللوحان بمقاس المصدر وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `013.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
- **أربعة أعمال مستقلة:** يرجع كل جهاز إلى الصورة الأصلية وحدها، ويستكشف مقياس تذكرة وفراغاً خارجياً واقتصاصاً مائياً ولوحة ألوان وحقولاً وعلاقة ختم مختلفة.

الترابط لا يعني القص. تُولّد الملفات الأربعة وتُركّب وتُراجع منفصلة، من دون سلسلة مراجع متتابعة تسبب الانحراف.

## النص سجل هادئ داخل قسيمة المعلومات

قبل التوليد، اختر نصاً تلقائياً أو نصاً مخصصاً أو نتيجة بلا نص. عند وجود نص، حدّد اللغة أو المنطقة المستهدفة.

يستخلص النص التلقائي عنواناً شديد القصر من الموضوع أو اللحظة أو الحالة أو العلاقة أو العاطفة المرئية أو المدعومة، ثم يختار الحقول المفيدة فعلاً فقط.

إن DATE وPLACE وSUBJECT وMOMENT وFIELD وNO. أمثلة على منطق الحقول وليست تسميات إنجليزية ثابتة؛ تُوطّن التسميات والقيم معاً. تحتاج التواريخ والأماكن والإحداثيات والمسارات وأرقام التذاكر وأحداث السفر إلى ما يقدمه المستخدم أو دليل موثوق. وتستخدم الموضوعات غير السفرية سجلات الشيء أو الحالة أو المشروع أو الفصل أو الموسم أو العلاقة أو العاطفة بدلاً منها.
...
ينشئ نموذج الصور المشهد المائي المرتبط بعلاقة الموضوع والبيئة، والتذكرة الواحدة، وتقسيم 74/26، وحافة الورق، وخط الثقب، وشبكة المعلومات، والختم الدائري، والنص المحلي. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة؛ ولا يرسم العمل برمجياً.
...
- [التوجيه الصيني الكامل](references/xxd-panel-013-prompt.zh-CN.md)
- [التوجيه الإنجليزي الكامل](references/xxd-panel-013-prompt.en.md)
- [موجز الأسلوب الأصلي](references/013-source.md)
