...
لهذا الإحباط صنعت **Panel 013**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يحفظ الصورة داخل تذكرة مائية هادئة قابلة للاقتناء**.
